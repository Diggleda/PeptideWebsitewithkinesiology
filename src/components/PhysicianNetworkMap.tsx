...
export function PhysicianNetworkMap({
  ...
  return (
    <div className="physician-network-map-shell w-full">
      <div className="physician-network-map-stage mx-auto w-full max-w-none">
        {loading ? (
      ...
      {showDetails && (error || mappedDoctors.length > 0) ? (
