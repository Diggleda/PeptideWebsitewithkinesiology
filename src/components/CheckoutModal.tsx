            ...
            <>
                  ...
                  <div
                    className={`glass-card squircle-lg flex flex-wrap items-center justify-between gap-4 border px-6 py-4 transition-colors ${
                      retailPricingEnabled || isFacilityPickupEnabled
                        ...
                        : 'border-[rgba(11,6,121,0.28)] shadow-[0_20px_48px_-40px_rgba(11,6,121,0.22)] hover:border-[rgba(11,6,121,0.42)]'
                    }`}
                  >
                                  ...
                                  {!retailPricingEnabled && visibleTiers.length > 0 && (
                                    <div className="mt-3 glass-card squircle-sm border border-[var(--brand-glass-border-2)] p-3 space-y-2">
                                      ...
                                      >
                                        ...
                                        <span className="text-[rgb(11,6,121)] text-[0.65rem]">
                                                ...
                                                <span
                                                  className={
                                                    item.quantity >= tier.minQuantity
                                                      ? 'text-[rgb(11,6,121)] font-semibold'
                                                      : 'text-slate-600'
                                                  }
                                                >
              ...
              <div className="space-y-4">
                ...
                {isDoctorHandDeliveryEnabled && (
                  <div className="glass-card squircle-md border border-[rgba(11,6,121,0.45)] bg-gradient-to-r from-[rgba(11,6,121,0.16)] via-[rgba(11,6,121,0.10)] to-[rgba(255,255,255,0.75)] px-6 py-5 shadow-[0_14px_30px_-24px_rgba(11,6,121,0.9)]">
                    ...
                    {!isHandDeliveryEnabled && (
                      <div className="flex items-center gap-3">
                        <Button
                          ...
                          style={isDelegateFlow ? { backgroundColor: 'rgb(11, 6, 121)', borderColor: 'rgb(11, 6, 121)', color: '#ffffff', WebkitTextFillColor: '#ffffff' } : undefined}
                        >
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                        <Input
                          ...
                          className="h-10 w-full sm:flex-1 squircle-sm glass focus-visible:border-[rgb(11,6,121)] focus-visible:ring-[rgba(11,6,121,0.25)]"
                        />
                        <Button
                          type="button"
                          variant="outline"
