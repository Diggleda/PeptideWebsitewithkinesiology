...
const Checkbox = React.forwardRef<
  ...
  return (
    <CheckboxPrimitive.Root
      ...
      data-slot="checkbox"
      className={cn(
        "glass-checkbox peer relative grid h-5 w-5 shrink-0 place-items-center overflow-hidden rounded-[4px] border-2 border-slate-500/90 bg-white/65 backdrop-blur-2xl shadow-[0_3px_10px_-2px_rgba(15,23,42,0.4),inset_0_2px_rgba(255,255,255,0.9),inset_0_-1px_rgba(0,0,0,0.08)] ring-1 ring-inset ring-white/50 transition-all duration-200 outline-none hover:border-slate-600 hover:bg-white/75 hover:shadow-[0_4px_12px_-2px_rgba(15,23,42,0.45),inset_0_2px_rgba(255,255,255,0.95)] hover:ring-white/60 focus-visible:ring-2 focus-visible:ring-[rgb(11,6,121)]/65 focus-visible:ring-offset-[1.5px] focus-visible:ring-offset-white/35 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-[rgb(11,6,121)] data-[state=checked]:border-[rgb(11,6,121)] data-[state=checked]:text-white data-[state=checked]:ring-[rgb(11,6,121)]/65 data-[state=checked]:shadow-[0_3px_10px_-2px_rgba(11,6,121,0.5),inset_0_1px_rgba(255,255,255,0.4)]",
        className,
      )}
      {...props}
    >
