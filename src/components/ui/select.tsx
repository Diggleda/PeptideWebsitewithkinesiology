...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'inline-flex w-full items-center justify-between gap-2 squircle-sm glass-card border border-[var(--brand-glass-border-2)] px-3 py-2 text-sm text-slate-700 transition-[color,box-shadow] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgb(11,6,121)] focus-visible:ring-offset-[1.5px] focus-visible:ring-offset-white/40 disabled:cursor-not-allowed disabled:opacity-50',
      className
    )}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-pointer select-none items-center rounded-lg pl-8 pr-3 py-2 text-sm text-slate-700 outline-none transition-colors hover:bg-[rgba(11,6,121,0.08)] focus:bg-[rgba(11,6,121,0.12)] data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50',
      className
    )}
    {...props}
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center text-[rgb(11,6,121)]">
