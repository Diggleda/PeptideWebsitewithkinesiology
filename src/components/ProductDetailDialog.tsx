                    ...
                    {tabs.map(tab => (
                      <button
                        ...
                        className={`px-4 py-3 text-sm font-medium whitespace-nowrap transition-all border-b-2 ${
                          activeTab === tab.id
                            ? 'border-[rgb(11,6,121)] text-[rgb(11,6,121)]'
                ...
                <div className="space-y-5 rounded-3xl border-2 border-[var(--brand-glass-border-2)] p-6 shadow-xl bg-white">
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea
                      ...
                      className="min-h-[100px] w-full resize-y squircle-lg p-4 text-sm border-2 border-[var(--brand-glass-border-2)] focus-visible:outline-none focus-visible:border-[rgb(11,6,121)] focus-visible:ring-2 focus-visible:ring-[rgba(11,6,121,0.2)] bg-slate-50"
                    />
                  </div>
