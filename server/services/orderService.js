    ...
    doctors.map((doctor) => {
      ...
      return [
        id,
        {
          ...
          leadTypeLockedAt: doctor.leadTypeLockedAt || doctor.lead_type_locked_at || null,
          salesRepId: repId || null,
          salesRepName: rep?.name || null,
          salesRepEmail: rep?.email || null,
          address1: doctor.address1 || doctor.address_1 || doctor.officeAddressLine1 || null,
          address2: doctor.address2 || doctor.address_2 || doctor.officeAddressLine2 || null,
          city: doctor.city || doctor.officeCity || null,
          state: doctor.state || doctor.officeState || null,
          postalCode: doctor.postalCode || doctor.postcode || doctor.zip || doctor.officePostalCode || null,
          country: doctor.country || doctor.officeCountry || null,
        },
      ];
    }),
  );
  ...
  if (summaryOnly) {
    return {
      user: {
        ...
        phone: targetUser?.phone || targetSalesRepRecord?.phone || null,
