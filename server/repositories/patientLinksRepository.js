...
const linkSnapshotParams = (link, doctorId) => {
  ...
  return {
    ...
    delegate_name: normalizeOptionalString(link?.delegateName ?? link?.delegate_name),
    delegate_contact: normalizeOptionalString(link?.delegateContact ?? link?.delegate_contact),
    delegate_role: normalizeOptionalString(link?.delegateRole ?? link?.delegate_role, 64),
    ...
    delegate_permission: normalizeOptionalString(link?.delegatePermission ?? link?.delegate_permission, 64) || 'submit_for_physician_review',
    ...
    pricing_disclosure: normalizeOptionalString(link?.pricingDisclosure ?? link?.pricing_disclosure, 1000),
    zelle_recipient_name: normalizeOptionalString(link?.zelleRecipientName ?? link?.zelle_recipient_name),
    payment_confirmation_required: (link?.paymentConfirmationRequired ?? link?.payment_confirmation_required) === false ? 0 : 1,
    delegate_instructions: normalizeOptionalString(link?.delegateInstructions ?? link?.delegate_instructions, 4000),
