...
const normalizePackageDimensions = (dimensions = {}) => {
...
const normalizeShippingEstimate = (estimate = {}) => {
  ...
  const packageDimensions = normalizePackageDimensions(
    estimate.packageDimensions || estimate.dimensions,
  );
  return {
    ...
    packageCode: normalizeString(estimate.packageCode) || null,
    weightOz: normalizeAmount(estimate.weightOz),
    packageDimensions,
    meta: typeof estimate.meta === 'object' && estimate.meta !== null ? estimate.meta : null,
  };
};
