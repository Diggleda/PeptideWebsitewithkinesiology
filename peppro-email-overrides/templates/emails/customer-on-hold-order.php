<?php
/**
 * Customer on-hold order email (PepPro override)
 *
 * This template is loaded via the `peppro-email-overrides` plugin to customize the intro
...
<?php if ( function_exists( 'peppro_is_zelle_order' ) && peppro_is_zelle_order( $order ) ) : ?>
	<?php
		$msg = "We received your order! Please Zelle support@peppro.net with the memo 'Order #{$order->get_order_number()}'.";
	?>
