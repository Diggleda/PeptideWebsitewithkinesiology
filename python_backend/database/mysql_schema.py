...
CREATE_TABLE_STATEMENTS = [
    ...
    CREATE TABLE IF NOT EXISTS users (
        ...
        delegate_background_url LONGTEXT NULL,
    ...
    CREATE TABLE IF NOT EXISTS peptide_forum_posts (
        ...
        INDEX idx_peptide_forum_posts_end (end_at),
...
def ensure_schema() -> None:
    ...
    migrations = [
        ...
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS delegate_background_url LONGTEXT NULL",
        ...
        "ALTER TABLE peptide_forum_posts ADD COLUMN IF NOT EXISTS end_at DATETIME NULL",
        "ALTER TABLE peptide_forum_posts ADD COLUMN IF NOT EXISTS end_date_raw VARCHAR(190) NULL",
        "ALTER TABLE peptide_forum_posts ADD COLUMN IF NOT EXISTS end_time_raw VARCHAR(64) NULL",
        "ALTER TABLE peptide_forum_posts ADD COLUMN IF NOT EXISTS duration_minutes INT NULL",
    ...
    try:
        if not _column_exists("users", "delegate_background_url"):
            mysql_client.execute("ALTER TABLE users ADD COLUMN delegate_background_url LONGTEXT NULL")
    except Exception:
        pass

    try:
        if _column_exists("users", "delegate_background_image_url") and _column_exists("users", "delegate_background_url"):
            mysql_client.execute(
                """
                UPDATE users
