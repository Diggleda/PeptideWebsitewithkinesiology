...
CREATE_TABLE_STATEMENTS = [
    ...
    CREATE TABLE IF NOT EXISTS users (
        ...
        bio TEXT NULL,
        network_presence_agreement TINYINT(1) NOT NULL DEFAULT 0,
...
def ensure_schema() -> None:
    ...
    migrations = [
        ...
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS network_presence_agreement TINYINT(1) NOT NULL DEFAULT 0",
