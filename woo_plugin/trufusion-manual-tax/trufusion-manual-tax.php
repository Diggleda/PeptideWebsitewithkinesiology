...
final class TruFusion_Labs_Manual_Tax_Sync {
  private const META_TAX_TOTAL = 'trufusion_tax_total';
  private const META_RATE_ID = 'trufusion_manual_tax_rate_id';
  private const META_SYNCED_AT = 'trufusion_tax_synced_at';
  ...
  private static function log(string $level, string $message, array $context = []): void {
    ...
    if (function_exists('error_log')) {
      error_log('[trufusion-manual-tax] ' . $message . ' ' . wp_json_encode($context));
    }
  }
...
TruFusion_Labs_Manual_Tax_Sync::init();
